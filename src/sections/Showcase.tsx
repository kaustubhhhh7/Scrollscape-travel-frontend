...
const destinations = [
    {
        id: "01",
        title: "Highlands",
        img: "https://images.unsplash.com/photo-1486915309851-b0cc1f8a0084?w=1600&q=80",
        loc: "Scotland"
    },
    {
        id: "02",
            ...
            <div className="sticky top-0 flex h-screen items-center overflow-hidden">
                <motion.div style={{ x }} className="flex gap-8 md:gap-24 px-4 md:px-24 items-center">
                    <div className="flex flex-col justify-center min-w-[85vw] md:min-w-[30vw] shrink-0">
                        <span className="text-[10px] uppercase tracking-[0.4em] text-gold mb-8">Selected Works</span>
                    ...
                    {destinations.map((dest) => (
                        <motion.div
                            ...
                            className="relative group w-[85vw] md:w-[40vw] flex-shrink-0 aspect-[3/4] md:aspect-[4/5] overflow-hidden transition-all duration-300 cursor-pointer shadow-2xl"
                        >
                            <motion.img
                                layoutId={`destination-image-${dest.id}`}
                                src={dest.img}
                                alt={dest.title}
                                className="w-full h-full object-cover grayscale brightness-[0.8] group-hover:grayscale-0 group-hover:brightness-105 transition-all duration-1000 ease-[0.16,1,0.3,1]"
                            />
                            ...
                            <div className="absolute bottom-0 left-0 p-6 md:p-8 pointer-events-none">
                                <h3 className="text-4xl md:text-7xl font-serif text-transparent stroke-text group-hover:text-white transition-colors duration-400">
                                    {dest.title}
                                </h3>
                            </div>
                        </motion.div>
                    ...
                    <div className="flex flex-col justify-center min-w-[50vw] md:min-w-[30vw] pl-12 md:pl-24">
                        <span className="text-3xl md:text-6xl font-serif opacity-30 uppercase tracking-widest">Scroll <br /> More</span>
                    </div>
                </motion.div>
            </div>
